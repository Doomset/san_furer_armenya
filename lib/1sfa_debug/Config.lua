...
local json = function(orig_t, save_name)
	...
	local save = function(save_orig)
		...
		assert(f, 'Папка для сохранинние коонфига не открылась!')
